...
export default {
  ...
  components: {
    ...
    mounted(){
      ...
      eventBus.$on('country-visited', (visitedCountry) => {
        const index = this.bucketList.findIndex(country => country._id === visitedCountry._id)
        this.bucketList.splice(index, 1, visitedCountry)
      })
    },
    methods: {
      getCountries(){
      ...
      addToBucketList(){
        ...
        BucketService.postBucketList(newCountry)
